...
These values are available through `FermiFlows.blg_reference_setup()`.
...
@software{fermiflows_zenodo,
  ...
  title = {{FermiFlows}: Extensible 2D Fermi-liquid kinetic transport on unstructured meshes},
  year = {2026},
  publisher = {Zenodo},
