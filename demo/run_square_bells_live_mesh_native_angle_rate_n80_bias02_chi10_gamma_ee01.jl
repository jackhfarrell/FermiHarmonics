...
function main()
    ...
    run_name = "square_bells_live_mesh_native_angle_rate_n80_bias02_chi10_gamma_ee01"
    live_h5_path = joinpath(project_root, "live_viz_$(run_name)_mesh_native.h5")

    @info "Running square bells angle-rate live mesh-native case" mu0 mass gamma_mr gamma_ee bias chi n_angles polydeg=params.polydeg tspan_end=params.tspan_end residual_tol=params.residual_tol
