...
function main()
    ...
    run_name = "nonlinear_live_gamma_ee1_M10_bias04_poly3"

    @info "Running nonlinear live visualization case" mu0 mass gamma_mr gamma_ee bias max_harmonic polydeg=params.polydeg tspan_end=params.tspan_end
