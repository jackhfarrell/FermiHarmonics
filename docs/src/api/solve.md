...
- Default logarithmic map is `gamma_total=0 -> M=100` and `gamma_total>=500 -> M=4`.
...
- `(\gamma_mr, \gamma_mc) = (0, 100)` gives `M = 28`
- `(\gamma_mr, \gamma_mc) = (0, 500)` gives `M = 4`
