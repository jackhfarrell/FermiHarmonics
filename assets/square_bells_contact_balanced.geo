// Square-bells geometry with explicit symmetric contact discretization.
...
// Keep the contact and stem discretization matched between top and bottom.
Transfinite Curve {1, 11} = 9 Using Progression 1;
Transfinite Curve {2, 10, 12, 20} = 11 Using Progression 1;
Transfinite Curve {3, 9, 13, 19} = 3 Using Progression 1;
