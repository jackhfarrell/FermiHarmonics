...
def main():
    ...
    geo_path = repo_root / "projects/simple_geometries/meshes/junction/junction.geo"
    ...
    contact_colors = {
        "left": CONTACT_COLORS["west_drain"],
        "middle": CONTACT_COLORS["north_drain"],
        "right": CONTACT_COLORS["east_drain"],
        "bottom": "white",
    }
    ...
    out_path = Path(__file__).with_name("junction_illustration.png")
