...
function main()
    ...
    run_name = "tesla_valve_live_mesh_native_exact_angle_n50_bias01_chi10_gamma_mc01"
    live_h5_path = joinpath(project_root, "live_viz_$(run_name)_mesh_native.h5")

    @info "Running Tesla valve exact-angle live mesh-native case" mu0 mass gamma_mr gamma_mc bias chi n_angles polydeg=params.polydeg tspan_end=params.tspan_end residual_tol=params.residual_tol
