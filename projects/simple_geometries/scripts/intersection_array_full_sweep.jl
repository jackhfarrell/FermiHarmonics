# run a large parameter sweep for the simple_geometries intersection problem, sweeping over gamma_mr and gamma_mc using
...
results_root = joinpath(project_root, "full_sweeps")
n_jobs = 125
cases_per_job = 20
mkpath(results_root)
...
boundary_conditions = Dict(
    ...
    :contact_side => OhmicContactBC(-bias / 2),
)
...
if !haskey(ENV, "SLURM_ARRAY_TASK_ID")
    ...
    @info "Intersection full sweep submission" name mesh=basename(mesh_path) bias p_scatter total_cases
