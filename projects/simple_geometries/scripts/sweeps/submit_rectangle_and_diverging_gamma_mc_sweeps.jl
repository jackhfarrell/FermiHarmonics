# submit gamma_ee-only sweeps for rectangle, diverging nozzle, and dogleg with fixed p_scatter and gamma_mr.
...
sweep_scripts = [
    joinpath(@__DIR__, "rectangle_gamma_ee_sweep_array.jl"),
    joinpath(@__DIR__, "diverging_nozzle_gamma_ee_sweep_array.jl"),
    joinpath(@__DIR__, "dogleg_gamma_ee_sweep_array.jl"),
]
