# run a large parameter sweep for the simple_geometries diverging nozzle problem, sweeping over gamma_mr and gamma_mc using
...
if !haskey(ENV, "SLURM_ARRAY_TASK_ID")
    ...
    @info "Diverging nozzle sweep submission" name mesh=basename(mesh_path) bias p_scatter total_cases
