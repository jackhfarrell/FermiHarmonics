# run a gamma_ee-only parameter sweep for the simple_geometries rectangle problem at fixed gamma_mr using
...
# sweep configuration
name = "simple_geometries_rectangle_gamma_ee_sweep"
...
if !haskey(ENV, "SLURM_ARRAY_TASK_ID")
    ...
    @info "Rectangle gamma_ee sweep submission" name mesh=basename(mesh_path) bias p_scatter gamma_mr_fixed total_cases
