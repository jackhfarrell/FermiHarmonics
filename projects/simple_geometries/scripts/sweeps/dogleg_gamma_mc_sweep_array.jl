# run a gamma_ee-only parameter sweep for the simple_geometries dogleg problem at fixed gamma_mr using
...
# sweep configuration
name = "simple_geometries_dogleg_gamma_ee_sweep"
...
if !haskey(ENV, "SLURM_ARRAY_TASK_ID")
    ...
    @info "Dogleg gamma_ee sweep submission" name mesh=basename(mesh_path) bias p_scatter gamma_mr_fixed total_cases
