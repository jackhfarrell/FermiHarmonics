...
- Repository overview and setup: [README.md](/Users/jfarrell/Desktop/ElectronKinetics.jl/README.md)
...
- Keep reusable Julia code in [src/](/Users/jfarrell/Desktop/ElectronKinetics.jl/src), geometry-specific scripts in [projects/simple_geometries/scripts](/Users/jfarrell/Desktop/ElectronKinetics.jl/projects/simple_geometries/scripts), and analysis artifacts in sibling subfolders only when they are specific to this subproject.
- Keep dependencies declared in [Project.toml](/Users/jfarrell/Desktop/ElectronKinetics.jl/Project.toml) and avoid adding unnecessary packages for one-off scripts.
- When behavior changes in shared solver logic, add or update tests under [test/](/Users/jfarrell/Desktop/ElectronKinetics.jl/test).
