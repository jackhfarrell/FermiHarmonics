...
SWEEP_GLOBS = [
    "simple_geometries_dogleg_gamma_ee_sweep_sweep_*",
    "simple_geometries_dogleg_gamma_ee_sweep_*",
    "simple_geometries_dogleg_sweep_*",
]
HARDCODED_SWEEP_DIR = RESULTS_ROOT / "simple_geometries_dogleg_gamma_ee_sweep_sweep_2026-02-25_145852"

GAMMA_MR_TARGET = 1e-2
GAMMA_MR_TOL = 1e-12
CONTACT_SAMPLE_DEPTH = 2

OUT_CSV = Path(__file__).resolve().parent / "dogleg_conductance_vs_gamma_ee.csv"
OUT_PNG = Path(__file__).resolve().parent / "dogleg_conductance_vs_gamma_ee.png"
